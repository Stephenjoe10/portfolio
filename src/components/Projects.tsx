...
const projects = [
  {
    title: 'React Native Chess Engine',
    category: 'Complex State & UI',
    hook: "A deep dive into complex state logic and move validation.",
    highlight: "Engineered a custom move-validation system and optimized UI rendering for a lag-free board experience.",
    tech: ['React Native', 'SVG', 'Custom Logic', 'TypeScript'],
    color: "from-blue-500/20 to-purple-500/20"
  },
  {
    title: 'POS Retail System',
    category: 'Enterprise Hardware Integration',
    hook: "Enterprise-grade retail software.",
    highlight: "Implemented hardware-level barcode scanning and optimized the checkout flow for high-speed retail environments.",
    tech: ['React Native', 'Barcode Scanning', 'Product Flow Optimization'],
    color: "from-emerald-500/20 to-teal-500/20"
  },
  {
    title: 'react-native-battery-info-pro',
    category: 'NPM Package / Open Source',
    hook: "Bridging the gap between TSX and Kotlin.",
    highlight: "Developed a native module using Kotlin to expose real-time battery diagnostics to the React Native layer, ensuring high accuracy and low battery overhead.",
    tech: ['Kotlin', 'Android', 'JSI', 'Native Modules'],
    ...
    <section id="projects" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <motion.div
           ...
           className="mb-16"
        >
          <h2 className="text-4xl md:text-5xl font-black mb-4">High-Impact <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Wins</span></h2>
          <p className="text-slate-400 text-lg max-w-2xl">Detailed looks at complex challenges and how I engineered precise, high-performance solutions for them.</p>
        </motion.div>
        ...
        <div className="flex flex-col gap-12 lg:gap-16">
          {projects.map((project, index) => (
            ...
            >
               ...
               <div className={`absolute top-0 right-0 w-full lg:w-1/2 h-full bg-gradient-to-br ${project.color} opacity-30 lg:opacity-10 blur-3xl pointer-events-none group-hover:opacity-40 transition-opacity duration-700`} />
               ...
               <div className="w-full flex-1 flex flex-col justify-center relative z-10">
                 ...
                 <div className="mb-8">
                   <p className="text-blue-300 font-medium text-lg mb-3">"{project.hook}"</p>
                   <p className="text-slate-400 leading-relaxed">
                     <strong className="text-slate-200">The Win:</strong> {project.highlight}
                   </p>
                 </div>
